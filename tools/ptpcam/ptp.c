...
ptp_get_operation_name(PTPParams* params, uint16_t oc)
{
    ...
    static struct {
                ...
                {PTP_OC_CANON_AdapterTransferProgress,         N_("PTP_OC_CANON_AdapterTransferProgress")},
                {PTP_OC_CANON_AFCancel,                        N_("PTP_OC_CANON_AFCancel")},
                {PTP_OC_CANON_BLERequest,                      N_("PTP_OC_CANON_BLERequest")},
                {PTP_OC_CANON_BulbEnd,                         N_("PTP_OC_CANON_BulbEnd")},
                {PTP_OC_CANON_BulbStart,                       N_("PTP_OC_CANON_BulbStart")},
                {PTP_OC_CANON_CancelTransfer,                  N_("PTP_OC_CANON_CancelTransfer")},
                {PTP_OC_CANON_CancelTransfer2,                 N_("PTP_OC_CANON_CancelTransfer2")},
                {PTP_OC_CANON_CancelTransfer_DT,               N_("PTP_OC_CANON_CancelTransfer_DT")},
                {PTP_OC_CANON_ceresCloseFileValue,             N_("PTP_OC_CANON_ceresCloseFileValue")},
                {PTP_OC_CANON_ceresCreateDirectoryValue,       N_("PTP_OC_CANON_ceresCreateDirectoryValue")},
                {PTP_OC_CANON_ceresCreateFileValue,            N_("PTP_OC_CANON_ceresCreateFileValue")},
                {PTP_OC_CANON_ceresFileAttributesValue,        N_("PTP_OC_CANON_ceresFileAttributesValue")},
                {PTP_OC_CANON_ceresFileTimeValue,              N_("PTP_OC_CANON_ceresFileTimeValue")},
                {PTP_OC_CANON_ceresGetUpdateFileData,          N_("PTP_OC_CANON_ceresGetUpdateFileData")},
                {PTP_OC_CANON_ceresGetWriteObject,             N_("PTP_OC_CANON_ceresGetWriteObject")},
                {PTP_OC_CANON_ceresNotifyBtStatus,             N_("PTP_OC_CANON_ceresNotifyBtStatus")},
                {PTP_OC_CANON_ceresNotifyDriveStatus,          N_("PTP_OC_CANON_ceresNotifyDriveStatus")},
                {PTP_OC_CANON_ceresNotifyNetworkError,         N_("PTP_OC_CANON_ceresNotifyNetworkError")},
                {PTP_OC_CANON_ceresOpenFileValue,              N_("PTP_OC_CANON_ceresOpenFileValue")},
                {PTP_OC_CANON_ceresRemoveDirectoryValue,       N_("PTP_OC_CANON_ceresRemoveDirectoryValue")},
                {PTP_OC_CANON_ceresRemoveFileValue,            N_("PTP_OC_CANON_ceresRemoveFileValue")},
                {PTP_OC_CANON_ceresRenameFileValue,            N_("PTP_OC_CANON_ceresRenameFileValue")},
                {PTP_OC_CANON_ceresRequestAdapterProperty,     N_("PTP_OC_CANON_ceresRequestAdapterProperty")},
                {PTP_OC_CANON_ceresSeekFileValue,              N_("PTP_OC_CANON_ceresSeekFileValue")},
                {PTP_OC_CANON_ceresSEndBtPairingResult,        N_("PTP_OC_CANON_ceresSEndBtPairingResult")},
                {PTP_OC_CANON_ceresSEndBtSearchResult,         N_("PTP_OC_CANON_ceresSEndBtSearchResult")},
                {PTP_OC_CANON_ceresSEndDriveInfo,              N_("PTP_OC_CANON_ceresSEndDriveInfo")},
                {PTP_OC_CANON_ceresSEndFactoryProperty,        N_("PTP_OC_CANON_ceresSEndFactoryProperty")},
                {PTP_OC_CANON_ceresSEndFileInfo,               N_("PTP_OC_CANON_ceresSEndFileInfo")},
                {PTP_OC_CANON_ceresSEndFileInfoListEx,         N_("PTP_OC_CANON_ceresSEndFileInfoListEx")},
                {PTP_OC_CANON_ceresSEndGpsInfo,                N_("PTP_OC_CANON_ceresSEndGpsInfo")},
                {PTP_OC_CANON_ceresSEndHostInfo,               N_("PTP_OC_CANON_ceresSEndHostInfo")},
                {PTP_OC_CANON_ceresSEndReadObject,             N_("PTP_OC_CANON_ceresSEndReadObject")},
                {PTP_OC_CANON_ceresSEndScanningResult,         N_("PTP_OC_CANON_ceresSEndScanningResult")},
                {PTP_OC_CANON_ceresSEndWizardInfo,             N_("PTP_OC_CANON_ceresSEndWizardInfo")},
                {PTP_OC_CANON_ceresSEndWpsPinCode,             N_("PTP_OC_CANON_ceresSEndWpsPinCode")},
                {PTP_OC_CANON_ceresSplitFileValue,             N_("PTP_OC_CANON_ceresSplitFileValue")},
                {PTP_OC_CANON_ceresTruncateFileValue,          N_("PTP_OC_CANON_ceresTruncateFileValue")},
                {PTP_OC_CANON_ChangePhotoStudioMode,           N_("PTP_OC_CANON_ChangePhotoStudioMode")},
                {PTP_OC_CANON_CHDK,                            N_("PTP_OC_CANON_CHDK")},
                {PTP_OC_CANON_ClickWB,                         N_("PTP_OC_CANON_ClickWB")},
                {PTP_OC_CANON_CompleteAutoSendImages,          N_("PTP_OC_CANON_CompleteAutoSendImages")},
                {PTP_OC_CANON_CreageObject,                    N_("PTP_OC_CANON_CreageObject")},
                {PTP_OC_CANON_CreateHandle,                    N_("PTP_OC_CANON_CreateHandle")},
                {PTP_OC_CANON_CREATEHANDLE64,                  N_("PTP_OC_CANON_CREATEHANDLE64")},
                {PTP_OC_CANON_DeleteObject,                    N_("PTP_OC_CANON_DeleteObject")},
                {PTP_OC_CANON_DeleteRootCertificateData,       N_("PTP_OC_CANON_DeleteRootCertificateData")},
                {PTP_OC_CANON_DeleteWebServiceData,            N_("PTP_OC_CANON_DeleteWebServiceData")},
                {PTP_OC_CANON_DepthOfFieldPreview,             N_("PTP_OC_CANON_DepthOfFieldPreview")},
                {PTP_OC_CANON_DistinctionRTC,                  N_("PTP_OC_CANON_DistinctionRTC")},
                {PTP_OC_CANON_DoAF,                            N_("PTP_OC_CANON_DoAF")},
                {PTP_OC_CANON_DriveLens,                       N_("PTP_OC_CANON_DriveLens")},
                {PTP_OC_CANON_DrivePowerZoom,                  N_("PTP_OC_CANON_DrivePowerZoom")},
                {PTP_OC_CANON_EndGetPartialObjectEX,           N_("PTP_OC_CANON_EndGetPartialObjectEX")},
                {PTP_OC_CANON_EndSendPartialObjectEx,          N_("PTP_OC_CANON_EndSendPartialObjectEx")},
                {PTP_OC_CANON_ExecuteEventProc,                N_("PTP_OC_CANON_ExecuteEventProc")},
                {PTP_OC_CANON_fapiMessageRX,                   N_("PTP_OC_CANON_fapiMessageRX")},
                {PTP_OC_CANON_fapiMessageTX,                   N_("PTP_OC_CANON_fapiMessageTX")},
                {PTP_OC_CANON_FormatRecoveryData,              N_("PTP_OC_CANON_FormatRecoveryData")},
                {PTP_OC_CANON_FormatStore,                     N_("PTP_OC_CANON_FormatStore")},
                {PTP_OC_CANON_GetAdapterFirmData,              N_("PTP_OC_CANON_GetAdapterFirmData")},
                {PTP_OC_CANON_GETAEDATA,                       N_("PTP_OC_CANON_GETAEDATA")},
                {PTP_OC_CANON_GetCameraSupport,                N_("PTP_OC_CANON_GetCameraSupport")},
                {PTP_OC_CANON_GetCtgInfo,                      N_("PTP_OC_CANON_GetCtgInfo")},
                {PTP_OC_CANON_GetDeviceInfoEX,                 N_("PTP_OC_CANON_GetDeviceInfoEX")},
                {PTP_OC_CANON_GetEvent,                        N_("PTP_OC_CANON_GetEvent")},
                {PTP_OC_CANON_GetEventProcReturnData,          N_("PTP_OC_CANON_GetEventProcReturnData")},
                {PTP_OC_CANON_GetGpsLogCurrentHandle,          N_("PTP_OC_CANON_GetGpsLogCurrentHandle")},
                {PTP_OC_CANON_GetGpsLoggingData,               N_("PTP_OC_CANON_GetGpsLoggingData")},
                {PTP_OC_CANON_GetImageRecoveryList,            N_("PTP_OC_CANON_GetImageRecoveryList")},
                {PTP_OC_CANON_GetImageRecoveryListEx,          N_("PTP_OC_CANON_GetImageRecoveryListEx")},
                {PTP_OC_CANON_GetIptcData,                     N_("PTP_OC_CANON_GetIptcData")},
                {PTP_OC_CANON_GetLensAdjust,                   N_("PTP_OC_CANON_GetLensAdjust")},
                {PTP_OC_CANON_GetMusicInfo,                    N_("PTP_OC_CANON_GetMusicInfo")},
                {PTP_OC_CANON_GetObject,                       N_("PTP_OC_CANON_GetObject")},
                {PTP_OC_CANON_GetObject64,                     N_("PTP_OC_CANON_GetObject64")},
                {PTP_OC_CANON_GetObjectInfo,                   N_("PTP_OC_CANON_GetObjectInfo")},
                {PTP_OC_CANON_GetObjectInfo64,                 N_("PTP_OC_CANON_GetObjectInfo64")},
                {PTP_OC_CANON_GetObjectInfoEX,                 N_("PTP_OC_CANON_GetObjectInfoEX")},
                {PTP_OC_CANON_GetObjectInfoEx64,               N_("PTP_OC_CANON_GetObjectInfoEx64")},
                {PTP_OC_CANON_GetObjectTime,                   N_("PTP_OC_CANON_GetObjectTime")},
                {PTP_OC_CANON_GetObjectUrl,                    N_("PTP_OC_CANON_GetObjectUrl")},
                {PTP_OC_CANON_GetPartialObject,                N_("PTP_OC_CANON_GetPartialObject")},
                {PTP_OC_CANON_GetPartialObject64,              N_("PTP_OC_CANON_GetPartialObject64")},
                {PTP_OC_CANON_GetPartialObjectEX,              N_("PTP_OC_CANON_GetPartialObjectEX")},
                {PTP_OC_CANON_GetPartialObjectEx64,            N_("PTP_OC_CANON_GetPartialObjectEx64")},
                {PTP_OC_CANON_GetPresetLensAdjustParam,        N_("PTP_OC_CANON_GetPresetLensAdjustParam")},
                {PTP_OC_CANON_GetRawDispImage,                 N_("PTP_OC_CANON_GetRawDispImage")},
                {PTP_OC_CANON_GetReducedObject,                N_("PTP_OC_CANON_GetReducedObject")},
                {PTP_OC_CANON_GetRemoteMode,                   N_("PTP_OC_CANON_GetRemoteMode")},
                {PTP_OC_CANON_GetReSizeData,                   N_("PTP_OC_CANON_GetReSizeData")},
                {PTP_OC_CANON_GetRootCertificateData,          N_("PTP_OC_CANON_GetRootCertificateData")},
                {PTP_OC_CANON_GetRootCertificateSpec,          N_("PTP_OC_CANON_GetRootCertificateSpec")},
                {PTP_OC_CANON_GetStorageIDS,                   N_("PTP_OC_CANON_GetStorageIDS")},
                {PTP_OC_CANON_GetStorageInfo,                  N_("PTP_OC_CANON_GetStorageInfo")},
                {PTP_OC_CANON_GetThumbEX,                      N_("PTP_OC_CANON_GetThumbEX")},
                {PTP_OC_CANON_GetTranscodeApproxSize,          N_("PTP_OC_CANON_GetTranscodeApproxSize")},
                {PTP_OC_CANON_GetTranscodedBlock,              N_("PTP_OC_CANON_GetTranscodedBlock")},
                {PTP_OC_CANON_GetViewfinderData,               N_("PTP_OC_CANON_GetViewfinderData")},
                {PTP_OC_CANON_GetWebServiceData,               N_("PTP_OC_CANON_GetWebServiceData")},
                {PTP_OC_CANON_GetWebServiceSpec,               N_("PTP_OC_CANON_GetWebServiceSpec")},
                {PTP_OC_CANON_GetWFTPROFILE,                   N_("PTP_OC_CANON_GetWFTPROFILE")},
                {PTP_OC_CANON_GET_GPSMOBILELINKOBJECTINFO,     N_("PTP_OC_CANON_GET_GPSMOBILELINKOBJECTINFO")},
                {PTP_OC_CANON_InitiateEventProc0,              N_("PTP_OC_CANON_InitiateEventProc0")},
                {PTP_OC_CANON_InitiateEventProc1,              N_("PTP_OC_CANON_InitiateEventProc1")},
                {PTP_OC_CANON_InitiateViewfinder,              N_("PTP_OC_CANON_InitiateViewfinder")},
                {PTP_OC_CANON_IsEventProcRunning,              N_("PTP_OC_CANON_IsEventProcRunning")},
                {PTP_OC_CANON_IsNeoKabotanProcMode,            N_("PTP_OC_CANON_IsNeoKabotanProcMode")},
                {PTP_OC_CANON_KeepDeviceON,                    N_("PTP_OC_CANON_KeepDeviceON")},
                {PTP_OC_CANON_LoadTransparentMemory,           N_("PTP_OC_CANON_LoadTransparentMemory")},
                {PTP_OC_CANON_MagicLantern,                    N_("PTP_OC_CANON_MagicLantern")},
                {PTP_OC_CANON_MovieSelectSWOff,                N_("PTP_OC_CANON_MovieSelectSWOff")},
                {PTP_OC_CANON_MovieSelectSWOn,                 N_("PTP_OC_CANON_MovieSelectSWOn")},
                {PTP_OC_CANON_NotifyAdapterStatus,             N_("PTP_OC_CANON_NotifyAdapterStatus")},
                {PTP_OC_CANON_NotifyAutoTransferStatus,        N_("PTP_OC_CANON_NotifyAutoTransferStatus")},
                {PTP_OC_CANON_NotifyEstimateNumberofImport,    N_("PTP_OC_CANON_NotifyEstimateNumberofImport")},
                {PTP_OC_CANON_NotifyFinish,                    N_("PTP_OC_CANON_NotifyFinish")},
                {PTP_OC_CANON_NotifyGpsTimeSyncStatus,         N_("PTP_OC_CANON_NotifyGpsTimeSyncStatus")},
                {PTP_OC_CANON_NotifyNumberofImported,          N_("PTP_OC_CANON_NotifyNumberofImported")},
                {PTP_OC_CANON_NotifySaveComplete,              N_("PTP_OC_CANON_NotifySaveComplete")},
                {PTP_OC_CANON_NotifySizeOfPartialDataTransfer, N_("PTP_OC_CANON_NotifySizeOfPartialDataTransfer")},
                {PTP_OC_CANON_NotifyUpdateProgress,            N_("PTP_OC_CANON_NotifyUpdateProgress")},
                {PTP_OC_CANON_PCHDDCapacity,                   N_("PTP_OC_CANON_PCHDDCapacity")},
                {PTP_OC_CANON_PopupBuiltinFlash,               N_("PTP_OC_CANON_PopupBuiltinFlash")},
                {PTP_OC_CANON_QuerySizeOfTransparentMemory,    N_("PTP_OC_CANON_QuerySizeOfTransparentMemory")},
                {PTP_OC_CANON_QuickLoadTransparentMemory,      N_("PTP_OC_CANON_QuickLoadTransparentMemory")},
                {PTP_OC_CANON_RegistBackgroundImage,           N_("PTP_OC_CANON_RegistBackgroundImage")},
                {PTP_OC_CANON_ReleaseReSizeData,               N_("PTP_OC_CANON_ReleaseReSizeData")},
                {PTP_OC_CANON_RemoteReleaseOFF,                N_("PTP_OC_CANON_RemoteReleaseOFF")},
                {PTP_OC_CANON_RemoteReleaseON,                 N_("PTP_OC_CANON_RemoteReleaseON")},
                {PTP_OC_CANON_Remote_Release,                  N_("PTP_OC_CANON_Remote_Release")},
                {PTP_OC_CANON_RequestDevelopEnd,               N_("PTP_OC_CANON_RequestDevelopEnd")},
                {PTP_OC_CANON_RequestDevelopStart,             N_("PTP_OC_CANON_RequestDevelopStart")},
                {PTP_OC_CANON_RequestDevicePropvalue,          N_("PTP_OC_CANON_RequestDevicePropvalue")},
                {PTP_OC_CANON_RequestTranscodeCancel,          N_("PTP_OC_CANON_RequestTranscodeCancel")},
                {PTP_OC_CANON_RequestTranscodeStart,           N_("PTP_OC_CANON_RequestTranscodeStart")},
                {PTP_OC_CANON_ResetMirrorLockupState,          N_("PTP_OC_CANON_ResetMirrorLockupState")},
                {PTP_OC_CANON_ResetTransfer,                   N_("PTP_OC_CANON_ResetTransfer")},
                {PTP_OC_CANON_ResetUILock,                     N_("PTP_OC_CANON_ResetUILock")},
                {PTP_OC_CANON_ReSizeImageData,                 N_("PTP_OC_CANON_ReSizeImageData")},
                {PTP_OC_CANON_SaveImageRecoveryData,           N_("PTP_OC_CANON_SaveImageRecoveryData")},
                {PTP_OC_CANON_SaveTransparentMemory,           N_("PTP_OC_CANON_SaveTransparentMemory")},
                {PTP_OC_CANON_SendCertData,                    N_("PTP_OC_CANON_SendCertData")},
                {PTP_OC_CANON_SendPartialObjectEx,             N_("PTP_OC_CANON_SendPartialObjectEx")},
                {PTP_OC_CANON_SendTimeSyncInfo,                N_("PTP_OC_CANON_SendTimeSyncInfo")},
                {PTP_OC_CANON_SendTimeSyncMessage,             N_("PTP_OC_CANON_SendTimeSyncMessage")},
                {PTP_OC_CANON_SEnd_ObjectEX,                   N_("PTP_OC_CANON_SEnd_ObjectEX")},
                {PTP_OC_CANON_SEnd_Partial_Object,             N_("PTP_OC_CANON_SEnd_Partial_Object")},
                {PTP_OC_CANON_SetAdapterBatteryReport,         N_("PTP_OC_CANON_SetAdapterBatteryReport")},
                {PTP_OC_CANON_SetCtgInfo,                      N_("PTP_OC_CANON_SetCtgInfo")},
                {PTP_OC_CANON_SetDevicePropvalueEX,            N_("PTP_OC_CANON_SetDevicePropvalueEX")},
                {PTP_OC_CANON_SetEventMode,                    N_("PTP_OC_CANON_SetEventMode")},
                {PTP_OC_CANON_SetFELock,                       N_("PTP_OC_CANON_SetFELock")},
                {PTP_OC_CANON_SetImageRecoveryData,            N_("PTP_OC_CANON_SetImageRecoveryData")},
                {PTP_OC_CANON_SetImageRecoveryDataEx,          N_("PTP_OC_CANON_SetImageRecoveryDataEx")},
                {PTP_OC_CANON_SetIptcData,                     N_("PTP_OC_CANON_SetIptcData")},
                {PTP_OC_CANON_SetLensAdjust,                   N_("PTP_OC_CANON_SetLensAdjust")},
                {PTP_OC_CANON_SetLiveAFFrame,                  N_("PTP_OC_CANON_SetLiveAFFrame")},
                {PTP_OC_CANON_SetLvPcFlavoreditMode,           N_("PTP_OC_CANON_SetLvPcFlavoreditMode")},
                {PTP_OC_CANON_SetLvPcFlavoreditParam,          N_("PTP_OC_CANON_SetLvPcFlavoreditParam")},
                {PTP_OC_CANON_SetNullPacketMode,               N_("PTP_OC_CANON_SetNullPacketMode")},
                {PTP_OC_CANON_SetObjectAttributes,             N_("PTP_OC_CANON_SetObjectAttributes")},
                {PTP_OC_CANON_SetObjectTime,                   N_("PTP_OC_CANON_SetObjectTime")},
                {PTP_OC_CANON_SetPROFILETOWFT,                 N_("PTP_OC_CANON_SetPROFILETOWFT")},
                {PTP_OC_CANON_SetRating,                       N_("PTP_OC_CANON_SetRating")},
                {PTP_OC_CANON_SetRemoteMode,                   N_("PTP_OC_CANON_SetRemoteMode")},
                {PTP_OC_CANON_SETREMOTESHOOTINGMODE,           N_("PTP_OC_CANON_SETREMOTESHOOTINGMODE")},
                {PTP_OC_CANON_SetRequestOlcInfoGroup,          N_("PTP_OC_CANON_SetRequestOlcInfoGroup")},
                {PTP_OC_CANON_SetRequestRollingPitching,       N_("PTP_OC_CANON_SetRequestRollingPitching")},
                {PTP_OC_CANON_SetRootCertificateData,          N_("PTP_OC_CANON_SetRootCertificateData")},
                {PTP_OC_CANON_SetUILock,                       N_("PTP_OC_CANON_SetUILock")},
                {PTP_OC_CANON_SetWebServiceData,               N_("PTP_OC_CANON_SetWebServiceData")},
                {PTP_OC_CANON_SetWFTPROFILE,                   N_("PTP_OC_CANON_SetWFTPROFILE")},
                {PTP_OC_CANON_SET_SENDGPSTAGINFO,              N_("PTP_OC_CANON_SET_SENDGPSTAGINFO")},
                {PTP_OC_CANON_TerminateEventProc_051,          N_("PTP_OC_CANON_TerminateEventProc_051")},
                {PTP_OC_CANON_TerminateEventProc_05D,          N_("PTP_OC_CANON_TerminateEventProc_05D")},
                {PTP_OC_CANON_TerminateViewfinder,             N_("PTP_OC_CANON_TerminateViewfinder")},
                {PTP_OC_CANON_TouchAfPosition,                 N_("PTP_OC_CANON_TouchAfPosition")},
                {PTP_OC_CANON_TransferComplete,                N_("PTP_OC_CANON_TransferComplete")},
                {PTP_OC_CANON_TransferComplete2,               N_("PTP_OC_CANON_TransferComplete2")},
                {PTP_OC_CANON_TransferCompleteTranscodedBlock, N_("PTP_OC_CANON_TransferCompleteTranscodedBlock")},
                {PTP_OC_CANON_TransferComplete_DT,             N_("PTP_OC_CANON_TransferComplete_DT")},
                {PTP_OC_CANON_UpdateFirmware,                  N_("PTP_OC_CANON_UpdateFirmware")},
                {PTP_OC_CANON_Zoom,                            N_("PTP_OC_CANON_Zoom")},
                {PTP_OC_CANON_ZoomPosition,                    N_("PTP_OC_CANON_ZoomPosition")},
                {0,NULL}
        };
    switch (params->deviceinfo.VendorExtensionID) {
        case PTP_VENDOR_EASTMAN_KODAK:
